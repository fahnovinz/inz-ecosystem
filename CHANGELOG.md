...
- VRAX World person card: **Jail** (Penjarakan) sends a patrol car from the police station to the nearest curb, officers walk the person to the car and they spend four hours in a cell (the Police Station card shows the cells and can release everyone); **Kill** (Bunuh) leaves the person lying where they stood, passers-by gather, and the police come to take the body away. Works on robbers mid-robbery too; closed bridges can stop the patrol, and the music turns tense while police are out
- VRAX World residents rebuilt as jointed 3D figures: shaped torso, thighs and shins that bend at the knee, arms that bend at the elbow, hands, shoes, a face (eyes, brows, nose, ears), hair, hijab or peci, and per-person build, stride and arm swing. A shader walk cycle with hip sway, bob and counter-twist is driven by the distance covered (no foot sliding), blends into a run with bent elbows, keeps umbrellas in hand and hands behind the back when arrested; shadows follow the pose. Position and heading are eased between sim ticks, and the camera zooms in to 7 m, aiming at chest height, when following someone
