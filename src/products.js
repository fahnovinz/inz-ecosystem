...
const PRODUCTS = [
  ...
  },
  {
    ...
    kind: "product",
    status: "new",
    tagline: "Miniature city sandbox: change one thing, watch the whole city react",
    command: "inz world",
    repo: "fahnovinz/inz-ecosystem",
    url: "https://github.com/fahnovinz/inz-ecosystem/tree/main/packages/vrax-world",
    license: "MIT",
    stack: ["three.js", "WebGL", "Vanilla JS", "Rule-based EN/ID interpreter"],
    highlights: [
      "People, traffic, weather, river and light share one simulation",
      "Commands in English or Bahasa Indonesia, parsed locally with no AI model",
      "Fires, a bank robbery, festivals, floods, blackouts and closed bridges",
      "Whole-world undo, guided showcase, no build step",
    ],
  },
  {
    id: "github-stats",
